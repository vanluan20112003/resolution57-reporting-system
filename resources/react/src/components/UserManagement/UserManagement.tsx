...
function UserManagement() {
        ...
        try {
          ...
          if (response.success) {
            ...
            localStorage.setItem(
              ...
              response.data.original_admin.id
            )
            localStorage.setItem(
              "impersonation_admin_email",
              response.data.original_admin.email
            )
            ...
            message.success(
              `Đã đăng nhập với tư cách ${response.data.user.email}`
            )
            ...
            message.error(
              response.message ||
                "Không thể đăng nhập với tư cách người dùng khác"
            )
      ...
      render: (date: string) => {
        ...
        return (
          <Tooltip title={lastLogin.toLocaleString("vi-VN")}>
            <Text type="secondary">
              {lastLogin.toLocaleDateString("vi-VN")}
            </Text>
          </Tooltip>
        )
      }
  ...
  const isImpersonating =
    localStorage.getItem("impersonation_admin_id") !== null
