...
const mockActivities: Activity[] = [
  {
    ...
    description:
      "Tổ chức lễ phát bảng tốt nghiệp cho sinh viên tốt nghiệp đợt tháng 10/2025, dự kiến 500 sinh viên tham dự",
    ...
    result_summary:
      "Đã hoàn thành chuẩn bị hội trường và in ấn bảng tốt nghiệp. Đang trong quá trình thông báo cho sinh viên.",
  ...
  },
  {
    ...
    description:
      "Tổ chức hội thảo quốc tế với sự tham gia của các chuyên gia hàng đầu trong lĩnh vực AI, dự kiến có 200 đại biểu",
    ...
    result_summary:
      "Đã gửi thư mời tới các chuyên gia. Đang chuẩn bị nội dung chương trình và tài liệu hội thảo.",
  ...
  },
  {
    ...
    description:
      "Tập huấn kỹ năng giảng dạy, nghiên cứu khoa học và quản lý lớp học cho 100 giảng viên trẻ",
    activity_type: "type-2",
    activity_field: "field-2",
    status: "COMPLETED",
  ...
  },
  {
    ...
    description:
      "Xây dựng và trang bị phòng thí nghiệm IoT hiện đại phục vụ nghiên cứu và đào tạo",
  ...
  },
  {
    ...
    description:
      "Triển khai chương trình trao đổi sinh viên và nghiên cứu chung với Đại học Stanford, Hoa Kỳ",
  ...
  },
  {
    ...
    description:
      "Tổng kết các hoạt động trong năm học 2024-2025, đề ra phương hướng cho năm học mới",
    activity_type: "type-1",
    activity_field: "field-2",
    status: "COMPLETED",
    lead_organization: "org-1",
  ...
  },
  {
    ...
    description:
      "Phát triển và triển khai hệ thống LMS cho toàn trường, hỗ trợ học tập trực tuyến và hybrid",
    activity_type: "type-5",
  ...
  },
  {
    ...
    description:
      "Nghiên cứu ứng dụng công nghệ Blockchain trong quản lý bằng cấp và chứng chỉ",
  ...
  },
  {
    ...
    description:
      "Tổ chức chương trình trao đổi 50 sinh viên sang học tập và thực tập tại các trường đại học Nhật Bản",
    activity_type: "type-4",
    activity_field: "field-3",
    status: "APPROVED",
    lead_organization: "org-5",
  ...
  },
  {
    ...
    description:
      "Tổ chức workshop hướng dẫn phương pháp nghiên cứu cho học viên cao học và nghiên cứu sinh",
    activity_type: "type-2",
    activity_field: "field-1",
    status: "COMPLETED",
              ...
              <Space direction="vertical" size={4} style={{ width: "100%" }}>
                <Space size={4}>
                  ...
                  <Text ellipsis style={{ fontSize: "13px" }}>
                    {
                      organizations[
                        item.lead_organization as keyof typeof organizations
                      ]
                    }
                  </Text>
                </Space>
              ...
              <Col xs={24} sm={12} md={8}>
                <Space direction="vertical" size={4} style={{ width: "100%" }}>
                  ...
                  <Tag>
                    {
                      activityTypes[
                        item.activity_type as keyof typeof activityTypes
                      ]
                    }
                  </Tag>
                </Space>
                ...
                <Space direction="vertical" size={4} style={{ width: "100%" }}>
                  ...
                  {item.activity_field && (
                    <Tag color="purple">
                      {
                        activityFields[
                          item.activity_field as keyof typeof activityFields
                        ]
                      }
                    </Tag>
                  )}
      ...
      <div style={{ padding: "24px" }}>
        ...
        <Space wrap style={{ marginBottom: "24px" }}>
          ...
          <Tag
            ...
            {statusMap[selectedActivity.status]?.label ||
          ...
          <Descriptions bordered column={2} size="middle">
            ...
            <Descriptions.Item label="Loại hoạt động">
              <Tag>
                {
                  activityTypes[
                    selectedActivity.activity_type as keyof typeof activityTypes
                  ]
                }
              </Tag>
            </Descriptions.Item>
            ...
            <Descriptions.Item label="Lĩnh vực">
              {selectedActivity.activity_field && (
                <Tag color="purple">
                  {
                    activityFields[
                      selectedActivity.activity_field as keyof typeof activityFields
                    ]
                  }
                </Tag>
              )}
            ...
            <Descriptions.Item label="Đơn vị chủ trì" span={2}>
              <Space>
                ...
                {
                  organizations[
                    selectedActivity.lead_organization as keyof typeof organizations
                  ]
                }
              </Space>
            </Descriptions.Item>
              ...
              <Space direction="vertical" size={4}>
                ...
                {selectedActivity.actual_end_date ? (
                  <Space>
                    ...
                    <Text>
                      Kết thúc:{" "}
                      {dayjs(selectedActivity.actual_end_date).format(
                        "DD/MM/YYYY"
                      )}
                    </Text>
                  </Space>
  ...
  return (
    <div style={{ padding: "24px" }}>
      <div style={{ marginBottom: "24px" }}>
        ...
        <Text type="secondary">
          Danh sách các hoạt động, dự án triển khai thực hiện Nghị quyết số
          57-NQ/TW
        </Text>
      </div>
