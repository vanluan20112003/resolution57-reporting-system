...
import { Card, List, Tag, Typography, Space, Input, Select, DatePicker, Progress, Descriptions, Button } from 'antd'
import {
  FileTextOutlined,
  CheckCircleOutlined,
  ClockCircleOutlined,
              ...
              <List.Item.Meta
                  ...
                  <Space direction="vertical" size={8} style={{ width: '100%' }}>
                    <Space>
                      ...
                      {item.completion_percentage > 0 && (
                        <Tag color="cyan">{item.completion_percentage}% hoàn thành</Tag>
                      )}
                    </Space>
                ...
                description={
                  <div style={{ marginTop: '12px' }}>
                    ...
                    {/* Summary Info */}
                    <Space wrap size={[16, 8]} style={{ marginBottom: '12px' }}>
                      <Space size={4}>
                        <TeamOutlined style={{ color: '#1890ff' }} />
                        <Text type="secondary">
                      ...
                      {item.budget && (
                        <Space size={4}>
                          <DollarOutlined style={{ color: '#faad14' }} />
                          <Text type="secondary">{formatCurrency(item.budget)}</Text>
                        </Space>
                      )}
                    </Space>
