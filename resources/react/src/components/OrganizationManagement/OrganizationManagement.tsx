...
function OrganizationManagement() {
  ...
  const filteredOrganizations = organizations.filter(org => {
    ...
    const matchIsVnuhcm = isVnuhcmFilter !== undefined ? org.is_vnuhcm === isVnuhcmFilter : true
  ...
  const getParentName = (parentId: string | null) => {
    ...
    return parent ? parent.short_name : '-'
  }
  ...
  const columns: ColumnsType<Organization> = [
    ...
    },
    {
      ...
      render: (status: string) => (
        <Tag color={status === OrganizationStatus.ACTIVE ? 'success' : 'default'}>
          {status === OrganizationStatus.ACTIVE ? 'Hoạt động' : 'Không hoạt động'}
        </Tag>
      ),
    },
    {
  ...
  return (
    <div style={{ padding: '24px' }}>
          ...
          <Space wrap style={{ width: '100%', justifyContent: 'space-between' }}>
            <Space wrap>
              ...
              <Select
                ...
                allowClear
              >
                <Option value={OrganizationType.UNIVERSITY_SYSTEM}>Đại học Quốc gia</Option>
                <Option value={OrganizationType.UNIVERSITY}>Trường thành viên</Option>
                <Option value={OrganizationType.RESEARCH_INSTITUTE}>Viện nghiên cứu</Option>
              ...
              >
                ...
                <Option value={OrganizationStatus.INACTIVE}>Không hoạt động</Option>
              </Select>
      ...
      <Modal
        ...
        cancelText="Hủy"
      >
        <Form form={form} layout="vertical" initialValues={{ status: OrganizationStatus.ACTIVE, is_vnuhcm: true }}>
          <Form.Item
            label="Mã đơn vị"
            name="code"
          ...
          <Space style={{ width: '100%' }} size="large">
            <Form.Item label="Thuộc ĐHQG-HCM" name="is_vnuhcm" valuePropName="checked">
              <Switch />
            </Form.Item>
        ...
        {selectedOrganization && (
          <Space direction="vertical" size="middle" style={{ width: '100%' }}>
            <div>
              ...
              <br />
              <Text strong style={{ fontSize: '16px' }}>{selectedOrganization.code}</Text>
            </div>

            <div>
              <Text type="secondary">Tên đơn vị:</Text>
              <br />
              <Title level={4} style={{ margin: 0 }}>{selectedOrganization.name}</Title>
            ...
            <Space wrap>
              <div>
                ...
                <br />
                <Tag color={getOrganizationTypeColor(selectedOrganization.type)}>
              ...
              {selectedOrganization.parent_id && (
                <div>
                  ...
                  <br />
                  <Text strong>{getParentName(selectedOrganization.parent_id)}</Text>
                </div>
              )}
              ...
              <div>
                ...
                <br />
                <Tag color={selectedOrganization.is_vnuhcm ? 'green' : 'default'}>
              ...
              <div>
                ...
                <br />
                <Tag color={selectedOrganization.status === OrganizationStatus.ACTIVE ? 'success' : 'default'}>
                  {selectedOrganization.status === OrganizationStatus.ACTIVE ? 'Hoạt động' : 'Không hoạt động'}
                </Tag>
              </div>
            </Space>
