...
function CollaboratingOrgsDisplay({
  ...
  return (
    <div style={{ marginTop: 2 }}>
      <TeamOutlined
        style={{ fontSize: iconSize, color: "#52c41a", marginRight: 2 }}
      />
...
function ReportBatchTab({ canDelete = false }: ReportBatchTabProps) {
  ...
  const [collaboratorSummary, setCollaboratorSummary] =
  ...
  const [activityViewMode, setActivityViewMode] = useState<"list" | "kpi">(
    "kpi"
  )
  ...
  const [exportPreviewData, setExportPreviewData] = useState<
    ExportPreviewResponse["data"] | null
  >(null)
  ...
  const getAllActivitiesMap = useCallback((): Map<
    string,
    BatchActivity | KpiActivityItem
  > => {
  ...
  const fetchActivitiesByKpi = async () => {
    ...
    try {
      ...
      message.error(
        error.message || "Không thể tải danh sách hoạt động theo KPI"
      )
    } finally {
      setActivitiesLoading(false)
    }
  ...
  const handleExportBatch = async (batchId: string) => {
    ...
    try {
      ...
      // Download the file
      const blob = await reportBatchApi.downloadBatchExport(
        batchId,
      ...
      render: (_, record) => (
        <Space direction="vertical" size={0}>
          {record.start_date && record.end_date ? (
            <Tooltip
              title={`${dayjs(record.start_date).format("DD/MM/YYYY HH:mm")} - ${dayjs(record.end_date).format("DD/MM/YYYY HH:mm")}`}>
  ...
  const pendingCount =
    (collaboratorSummary?.pending || 0) + (collaboratorSummary?.overdue || 0)
      ...
      {viewMode === "need_to_report" ? (
        ...
        <>
                  ...
                  <div
                    ...
                    <Form.Item
                      ...
                      rules={[
                        {
                          required: true,
                          message: "Vui lòng nhập tên đợt báo cáo"
                        }
                      ]}>
                      <Input
                        placeholder="VD: Đợt báo cáo tháng 1/2026"
                        maxLength={255}
                      />
                    </Form.Item>
                    ...
                    <Form.Item name="description" label="Mô tả">
                      <TextArea
                        rows={2}
                        placeholder="Mô tả ngắn về đợt báo cáo..."
                        maxLength={1000}
                      />
                    </Form.Item>
                  ...
                  <div
                    ...
                    <div
                      ...
                      <Space.Compact>
                        <Button
                          type={
                            activityViewMode === "kpi" ? "primary" : "default"
                          }
                        ...
                        <Button
                          type={
                            activityViewMode === "list" ? "primary" : "default"
                          }
                      ...
                      {activityViewMode === "list" && (
                        <Input
                          ...
                          onChange={(e) =>
                            setActivitySearchText(e.target.value)
                          }
                          style={{ width: 200 }}
                          size="small"
                          allowClear
                    ...
                    <div
                      ...
                      <Spin spinning={activitiesLoading} style={{ flex: 1 }}>
                        <div
                          style={{ height: 220, overflow: "auto", padding: 8 }}>
                          {/* KPI View */}
                                ...
                                kpiCategories.map((category) => (
                                  <div
                                    ...
                                    <div
                                      ...
                                      <Badge
                                        count={category.kpis.reduce(
                                          (sum, k) => sum + k.activities.length,
                                          0
                                        )}
                                        style={{
                                          marginLeft: 6,
                          ...
                          {activityViewMode === "list" && (
                            <Checkbox.Group
                              ...
                              onChange={(values) =>
                                setSelectedActivityIds(values as string[])
                              }
                              style={{ width: "100%" }}>
                                ...
                                availableActivities.map((activity) => (
                                  <div
                                    ...
                                    style={{
                                      ...
                                      background: selectedActivityIds.includes(
                                        activity.id
                                      )
                                        ? "#e6f7ff"
                                        : "transparent"
                    ...
                    <div
                      ...
                      <div
                        style={{ height: 180, overflow: "auto", padding: 8 }}>
                        {selectedActivityIds.length === 0 ? (
                          <Empty
                            image={Empty.PRESENTED_IMAGE_SIMPLE}
            ...
            footer={
              <div
                ...
                <Text type="secondary">
                  Tạo bởi:{" "}
                  <Text strong>
                    {detailBatch?.creator?.first_name}{" "}
                    {detailBatch?.creator?.last_name}
                  </Text>
                  {" • "}
                  {detailBatch?.created_at &&
                    dayjs(detailBatch.created_at).format("DD/MM/YYYY HH:mm")}
                </Text>
                <Space>
                  {detailBatch && (
                    <>
                                              ...
                                              content={
                                                <div style={{ maxWidth: 300 }}>
                                                  ...
                                                  <div
                                                    ...
                                                    {activity.collaborating_organizations.map(
                                                      (org, idx) => (
                                                        <Tag
                                                          key={org.id}
                                                          color="green"
                      ...
                      <div
                        ...
                        <div
                          ...
                          <Space>
                            ...
                            <span>
                              Phản hồi từ đơn vị phối hợp (theo hoạt động)
                            </span>
                            <Badge
                              count={
                                detailBatch.collaborator_responses?.length || 0
                        ...
                        <div
                          style={{ height: 200, overflow: "auto", padding: 8 }}>
                          {detailBatch.collaborator_responses &&
                          detailBatch.collaborator_responses.length > 0 ? (
                            // Group responses by activity
                            (() => {
                              const groupedByActivity =
                                detailBatch.collaborator_responses.reduce(
                                  (acc, response) => {
                                  ...
                                  {} as Record<
                                    string,
                                    {
                                      ...
                                      responses: typeof detailBatch.collaborator_responses
                                    }
                                  >
                                )
          ...
          <Modal
            ...
            footer={
              <div
                ...
                <Text type="secondary">{exportPreviewData?.batch?.name}</Text>
                <Space>
                  <Button onClick={() => setExportPreviewVisible(false)}>
                    Đóng
                  </Button>
                  <Button
                    type="primary"
                    ...
                    onClick={() =>
                      exportPreviewData &&
                      handleExportBatch(exportPreviewData.batch.id)
                    }>
                    Xuất Excel
                  </Button>
                </Space>
              ...
              {exportPreviewData && (
                <>
                    ...
                    <Col span={6}>
                      <div
                        ...
                        <Text strong style={{ fontSize: 20, color: "#52c41a" }}>
                          {
                            exportPreviewData.statistics
                              .activities_with_collaborators
                          }
                        </Text>
                      </div>
                    </Col>
                    <Col span={6}>
                      <div
                        ...
                        <Text strong style={{ fontSize: 20, color: "#fa8c16" }}>
                          {exportPreviewData.statistics.total_submitted}/
                          {
                            exportPreviewData.statistics
                              .total_required_responses
                          }
                        </Text>
                      </div>
                    </Col>
                  ...
                  <Segmented
                    ...
                    onChange={(value) =>
                      setActivePreviewTab(value as "activities" | "responses")
                    }
                    options={[
                      {
                        value: "activities",
                        label: `Sheet 1: Hoạt động (${exportPreviewData.activities.length})`
                      },
                      {
                        value: "responses",
                        label: `Sheet 2: Báo cáo đơn vị phối hợp (${exportPreviewData.collaborator_responses.length})`
                      }
                    ]}
                      ...
                      <div style={{ overflowX: "auto", maxHeight: 400 }}>
                        ...
                        {exportPreviewData.activities.length > 50 && (
                          <div
                            ...
                            <Text type="secondary">
                              Hiển thị 50/{exportPreviewData.activities.length}{" "}
                              hoạt động. Xuất Excel để xem đầy đủ.
                            </Text>
                          </div>
                        )}
                      </div>
                  ...
                  {activePreviewTab === "responses" && (
                    <div
                      ...
                      <div style={{ maxHeight: 400, overflow: "auto" }}>
                        {exportPreviewData.collaborator_responses.length ===
                        0 ? (
                          <Empty
                            image={Empty.PRESENTED_IMAGE_SIMPLE}
                          ...
                          exportPreviewData.collaborator_responses.map(
                            (group, groupIdx) => (
                              <div
                                ...
                                style={{
                                  borderBottom:
                                    groupIdx <
                                    exportPreviewData.collaborator_responses
                                      .length -
                                      1
                                      ? "2px solid #d9d9d9"
                                      : "none"
          ...
          <Modal
            ...
            centered
            footer={
              <Button onClick={() => setExportHistoryVisible(false)}>
                Đóng
              </Button>
            }>
