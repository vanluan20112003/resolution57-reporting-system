...
function CollaboratorReportView() {
  ...
  const [selectedActivity, setSelectedActivity] =
    useState<CollaboratorBatchActivity | null>(null)
                                  ...
                                  <div
                                    ...
                                    <div style={{ marginBottom: 4 }}>
                                      <Text
                                        ...
                                        />
                                        {
                                          activity.my_response.submitted_by
                                            ?.first_name
                                        }{" "}
                                        {
                                          activity.my_response.submitted_by
                                        ...
                                        {" • "}
                                        {dayjs(
                                          activity.my_response.submitted_at
                              ...
                              <div>
                                {activity.can_submit ? (
                                  <Button
                                    ...
                                    onClick={() =>
                                      handleOpenResponseForm(activity)
                                    }>
                                    {activity.my_response
                                      ? "Sửa"
                                      : "Nhập báo cáo"}
