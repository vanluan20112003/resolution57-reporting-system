...
import type { KpiCategory, CreateKpiCategoryRequest, UpdateKpiCategoryRequest } from '../../services/kpiApi'
...
function KpiCategoryManagement({ onCategoriesChange }: KpiCategoryManagementProps) {
  ...
  const handleModalOk = async () => {
    try {
      ...
      if (selectedCategory) {
        await kpiApi.updateKpiCategory(selectedCategory.id, values as UpdateKpiCategoryRequest)
      ...
      render: (_: any, record: KpiCategory) => (
        <Space>
          ...
          <Popconfirm
            ...
            okButtonProps={{
              danger: true,
              disabled: record.kpis_count !== undefined && record.kpis_count > 0
            }}
          >
            <Button
              type="link"
