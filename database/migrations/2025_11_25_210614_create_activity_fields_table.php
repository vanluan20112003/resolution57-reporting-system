...
{
    /**
     * Tạo bảng activity_fields - Lĩnh vực hoạt động
    ...
    public function up(): void
    {
        Schema::create('activity_fields', function (Blueprint $table) {
            ...
            // Tên lĩnh vực (unique)
            $table->string('name', 255)->unique()->comment('Tên lĩnh vực hoạt động');
        ...
        // Add indexes
        $this->addIndexSafe('activity_fields', 'name', 'idx_name');
        $this->addIndexSafe('activity_fields', 'is_active', 'idx_is_active');
    }
